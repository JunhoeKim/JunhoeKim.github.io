...
/* harmony import */ var _edit_common_feedback_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./edit/common/feedback.service */ "./src/app/edit/common/feedback.service.ts");
...
let AppComponent = class AppComponent {
    constructor(network, configService, demo, L, fs, router) {
    ...
    checkInstance() {
        this.network.checkInstance(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].mode)
            ...
            if (this.status.active) {
                ...
                if (this.status.config.service === 'demo') {
                    this.name = 'Autotator [DEMO]';
                }
                else if (this.status.config.service === 'quiz') {
                    this.name = 'Autotator [QUIZ]';
                }
            }
        });
    }
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_network_service__WEBPACK_IMPORTED_MODULE_2__["NetworkService"],
        ...
        _edit_common_feedback_service__WEBPACK_IMPORTED_MODULE_10__["FeedbackService"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateBoxStyleByScroll", function() { return updateBoxStyleByScroll; });
...
function getCurrRadius(svgS, focused = false) {
    ...
    const base = focused ? 7 : 4;
    return `${base / (1 + scale / 2)}px`;
}
function getCurrStrokeWidth(svgS, focused = false) {
    const svgEl = svgS.node();
    const scale = Object(src_app_d3_utils__WEBPACK_IMPORTED_MODULE_2__["invertTransform"])(svgEl.style.transform).sx;
    const base = focused ? 6 : 3;
    return `${base / (1 + scale / 2)}px`;
}
function updateBoxStyleByFocus(boxIndex, svgS) {
    const strokeWidth = getCurrStrokeWidth(svgS);
    const focusedStrokeWidth = getCurrStrokeWidth(svgS, true);
    const r = getCurrRadius(svgS);
    const focusedR = getCurrRadius(svgS, true);
    svgS.selectAll(`.mark:not(.handle)`)
        .classed('focused', false)
        .style('stroke-width', strokeWidth);
    svgS.selectAll('.mark.handle')
        .classed('focused', false)
        .attr('r', r);
    svgS.selectAll(`.text:not(.handle)`)
        .classed('focused', false)
        .style('stroke-width', strokeWidth);
    svgS.selectAll('.text.handle')
        .classed('focused', false)
        .attr('r', r);
    svgS.select(`.rect-${boxIndex}:not(.handle)`)
        .classed('focused', true)
        .style('stroke-width', focusedStrokeWidth);
    svgS.selectAll(`.circle-${boxIndex}:not(.handle)`)
        .classed('focused', true)
        .style('stroke-width', focusedStrokeWidth);
    svgS.selectAll(`.rect-${boxIndex}.handle`)
        .classed('focused', true)
        .attr('r', focusedR);
    svgS.selectAll(`.circle-${boxIndex}.handle`)
        .classed('focused', true)
        .attr('r', focusedR);
}
function updateBoxStyleByScroll(svgS) {
    ...
    svgS.selectAll('.text.handle')
        .attr('r', r);
    svgS.select(`.focused:not(.handle)`)
        .style('stroke-width', focusedStrokeWidth);
    svgS.selectAll(`.focused.handle`)
        .attr('r', focusedR);
}
class AnnotationBox {
...
function createEventArea(comp, mergeEvent, inputMode = 'rect') {
    ...
    const initRect = () => {
        ...
        comp.g.append('rect')
            ...
            .style('stroke-width', getCurrStrokeWidth(svg));
        pivotX = x;
        pivotY = y;
        comp.isDrawing = true;
...
function drawBoxMark(comp, box) {
    ...
    const rectS = comp.g.append('rect')
        ...
        .style('stroke-width', getCurrStrokeWidth(comp.svgS));
    const handles = getRectHandles(x, y, width, height);
...
function addMergeEvent(comp, boxIndex, rectS) {
    ...
    const merge = () => {
        ...
        const horizontalBoxes = mergedBoxes.filter(d => {
            const _x0 = d.points.x0.value;
            const _x1 = d.points.x1.value;
            const _y0 = d.points.y0.value;
            const _y1 = d.points.y1.value;
            return 1.5 * (_x1 - _x0) > (_y1 - _y0);
        });
        const alignHorizontal = horizontalBoxes.length > 0.5 * mergedBoxes.length;
...
let AxisSpecComponent = class AxisSpecComponent {
    ...
    ngOnInit() {
        ...
        this.hasMarkLabels = this.texts
            .filter(d => d.label.value === src_app_common_task__WEBPACK_IMPORTED_MODULE_4__["KEY_MARK_LABEL"]).length > 0;
    ...
    obtainValuePerPixel() {
        const dir = this.group.get('dir').value;
        const { width, height } = this.imgRef.nativeElement;
        const axis = dir === 'x'
            ? this.texts.filter(text => text.label.value === src_app_common_task__WEBPACK_IMPORTED_MODULE_4__["KEY_X_AXIS_LABEL"])
    ...
    mapMarkLabelToAxis() {
        const markLabelBoxes = this.texts.filter(d => {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], AxisSpecComponent.prototype, "imgRef", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
let CustomSpecComponent = class CustomSpecComponent {
    ...
    resetMarkLabels() {
        ...
        filteredMarkLabels.forEach(label => {
            ...
            const bothNominal = this.valueType === 'nominal' && !isNumber;
            const bothQuan = this.valueType === 'quantitative' && isNumber;
            const alreadyContains = labelForms.value
                .includes(label.text.value);
...
let OverallComponent = class OverallComponent {
    ...
    createEventArea() {
        ...
        if (this.controlPanelRef) {
            const rect = d3__WEBPACK_IMPORTED_MODULE_7__["select"]('#image-zone').node()
                .getBoundingClientRect();
            d3__WEBPACK_IMPORTED_MODULE_7__["select"](this.controlPanelRef.nativeElement)
                .style('top', `${Math.floor(rect.bottom)}px`)
                .style('left', `${Math.floor(rect.left)}px`)
                .style('width', `${Math.floor(rect.width)}px`);
        }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('controlPanel', { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], OverallComponent.prototype, "controlPanelRef", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let RawTableComponent = class RawTableComponent {
    ...
    predictWidth(targetGroup, column) {
        if (!targetGroup.contains('type') ||
            ...
            !targetGroup.contains('valuePerPixel') ||
            !targetGroup.contains('precision') ||
            !targetGroup.contains('unit')) {
            return;
        }
...
/* harmony import */ var _demo_line_data_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./demo_line_data.json */ "./src/app/edit/demo/demo_line_data.json");
var _demo_line_data_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./demo_line_data.json */ "./src/app/edit/demo/demo_line_data.json", 1);
/* harmony import */ var src_app_common_verification_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/common/verification-data */ "./src/app/common/verification-data.ts");
...
let DemoService = class DemoService {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.index >= paths.length) {
                ...
                if (this.currMode === 'revision') {
                    meta.feedbacks = elem.feedbacks.map((d) => new src_app_common_verification_data__WEBPACK_IMPORTED_MODULE_6__["Feedback"](d));
    ...
    getReview(path) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return new src_app_common_verification_data__WEBPACK_IMPORTED_MODULE_6__["Review"](reviewRaw);
        });
    }
    getNextMode() {
...
/* harmony import */ var _annotation_module_annotation_util__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./annotation-module/annotation-util */ "./src/app/edit/annotation-module/annotation-util.ts");
...
let EditComponent = class EditComponent {
    ...
    onImageScroll(event) {
        ...
        if (this.cursorInRect(event)) {
            ...
            const nScaleX = Math.min(6, Math.max(1, sx + scaleDelta));
            const nScaleY = Math.min(6, Math.max(1, sy + scaleDelta));
...
/* harmony import */ var src_app_locale_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/locale.service */ "./src/app/locale.service.ts");
/* harmony import */ var _timer_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../timer.service */ "./src/app/edit/timer.service.ts");
...
let SideNavComponent = class SideNavComponent {
    constructor(edit, network, cs, timer, L) {
        this.edit = edit;
        this.network = network;
        this.cs = cs;
        this.timer = timer;
...
SideNavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_edit_service__WEBPACK_IMPORTED_MODULE_2__["EditService"],
        ...
        _timer_service__WEBPACK_IMPORTED_MODULE_7__["TimerService"],
        src_app_locale_service__WEBPACK_IMPORTED_MODULE_6__["LocaleService"]])
], SideNavComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _network_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../network.service */ "./src/app/network.service.ts");
/* harmony import */ var _edit_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../edit.service */ "./src/app/edit.service.ts");
/* harmony import */ var _demo_demo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./demo/demo.service */ "./src/app/edit/demo/demo.service.ts");
...
let TimerService = class TimerService {
    constructor(network, edit, demo, router, zone) {
        this.network = network;
        this.edit = edit;
        this.demo = demo;
        this.router = router;
    ...
    sendResult(mode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.network.sendElapsedTime(mode, this.edit.image.path, this.sec);
        });
    }
};
...
TimerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_network_service__WEBPACK_IMPORTED_MODULE_2__["NetworkService"],
        _edit_service__WEBPACK_IMPORTED_MODULE_3__["EditService"],
        _demo_demo_service__WEBPACK_IMPORTED_MODULE_4__["DemoService"],
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! d3 */ "./node_modules/d3/index.js");
/* harmony import */ var src_app_locale_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/locale.service */ "./src/app/locale.service.ts");
/* harmony import */ var _annotation_module_annotation_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../annotation-module/annotation-util */ "./src/app/edit/annotation-module/annotation-util.ts");
...
let VOverallComponent = class VOverallComponent {
    ...
    updateFocus(key) {
        ...
        g.selectAll('rect')
            ...
            return Object(_annotation_module_annotation_util__WEBPACK_IMPORTED_MODULE_7__["getCurrStrokeWidth"])(this.svgS, d.key === key);
        });
        g.select('.focused').raise();
        if (!key) {
            return;
...
let LocaleService = class LocaleService {
    ...
    get completeMsg2() {
        return this.l === 'en'
            ...
            : '실험 참여비는 공지에 따라 추후에 제공됩니다. 감사합니다!';
    }
    get submit() {
...
let NetworkService = class NetworkService {
    ...
    sendElapsedTime(mode, path, time) {
        return this.http.post(`${this.BASE_URL}time`, {
            mode,
            path,
            time,
