    ...
    function () {
      ...
      _createClass(VOverallComponent, [{
        ...
        value: function initMarks() {
          ...
          }).style('stroke-width', Object(_annotation_module_annotation_util__WEBPACK_IMPORTED_MODULE_7__["getCurrStrokeWidth"])(this.svgS)).classed('mark', true).classed('focused', function (mark) {
        ...
        value: function initTexts() {
          ...
          g.selectAll('rect').data(this.data.texts).join('rect').attr('x', function (d) {
            ...
            return (d.bound[3] - d.bound[1]) * height;
          }).style('stroke-width', Object(_annotation_module_annotation_util__WEBPACK_IMPORTED_MODULE_7__["getCurrStrokeWidth"])(this.svgS)).classed('text', true).classed('focused', function (text) {
