    ...
    function () {
      ...
      _createClass(VOverallComponent, [{
        ...
        value: function initMarks() {
          ...
          }).attr('stroke-width', 2).attr('stroke', 'red').attr('fill', 'rgba(0, 0, 0, 0)').classed('focused', function (mark) {
        ...
        value: function initTexts() {
          ...
          g.selectAll('rect').data(this.data.texts).join('rect').attr('x', function (d) {
            ...
            return (d.bound[3] - d.bound[1]) * height;
          }).attr('stroke-width', 2).attr('stroke', 'red').attr('fill', 'rgba(0, 0, 0, 0)').classed('focused', function (text) {
